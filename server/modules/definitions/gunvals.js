module.exports = {
    ...
    iketurret: { reload: 1.2, recoil: 0, health: 1.25, damage: 1.2, pen: 1.2, speed: 2.5, maxSpeed: 2.5, range: 0.5, density: 4, spray: 0.25 },
       // Boss
       boss: { health: 1.3, damage: 1.3, pen: 1.3, density: 2 },
       mecha:{ reload: 1.32, recoil: 0.01, shudder: 0.01, health: 0.85, damage: 0.597, pen: 0.99, speed: 1.6, maxSpeed: 1.2, spray: 1.4 },
          // Pelleters
    pellet: { reload: .775, shudder: 0.75, health: 1.25, damage: 1.25, pen: 1.225, speed: 1.2, maxSpeed: 1.175, spray: 0.75 },
    bore: { reload: 1.2, shudder: 0.7, speed: 1.375, spray: 0.7, },
